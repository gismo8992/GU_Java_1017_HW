...
/*
 ...
 если приоритет одинаковый, то порядок не имеет значения. Методы с аннотациями @BeforeSuite и @AfterSuite должны
...
public class Main {
    ...
    public static void main(String[] args) {
        start("javaLevel3.lesson7.MyClass");
        start(MyClass.class);
    }
